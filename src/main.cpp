...
const string strMessageMagic = "NxcCoin Signed Message:\n";
...
{
    int64_t nSubsidy = nCoinAge * COIN_YEAR_REWARD * 50 / (365 * 33 + 8);
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NxcCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "1529672074";
        CTransaction txNew;
        txNew.nTime = 1529672074;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1529672074;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 953994;
        
       
                
        assert(block.hashMerkleRoot == uint256("0xb62deed420a87358d05daf9196a42dbcac714d93a2e30fecf13be258037c6f52"));
